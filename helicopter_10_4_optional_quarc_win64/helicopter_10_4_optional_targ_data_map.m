  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (helicopter_10_4_optional_P)
    ;%
      section.nData     = 25;
      section.data(25)  = dumData; %prealloc
      
	  ;% helicopter_10_4_optional_P.K
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_10_4_optional_P.K_ed
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 12;
	
	  ;% helicopter_10_4_optional_P.K_ei
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 13;
	
	  ;% helicopter_10_4_optional_P.K_ep
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 14;
	
	  ;% helicopter_10_4_optional_P.K_pd
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 15;
	
	  ;% helicopter_10_4_optional_P.K_pp
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 16;
	
	  ;% helicopter_10_4_optional_P.Vd_ff
	  ...
	  ;% helicopter_10_4_optional_P.HILInitialize_set_other_outputs
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 30;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_other_outpu_m
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 31;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_other_outpu_k
	  section.data(22).logicalSrcIdx = 21;
	  section.data(22).dtTransOffset = 32;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_other_outpu_j
	  ...
	  ;% helicopter_10_4_optional_P.HILReadEncoderTimebase_clock
	  section.data(1).logicalSrcIdx = 25;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_hardware_clocks
	  ...
	  ;% helicopter_10_4_optional_P.HILInitialize_watchdog_digital_
	  ...
	  ;% helicopter_10_4_optional_P.HILInitialize_analog_input_chan
	  ...
	  ;% helicopter_10_4_optional_P.HILReadEncoderTimebase_channels
	  section.data(3).logicalSrcIdx = 35;
	  section.data(3).dtTransOffset = 16;
	
	  ;% helicopter_10_4_optional_P.HILWriteAnalog_channels
	  section.data(4).logicalSrcIdx = 36;
	  section.data(4).dtTransOffset = 19;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_encoder_channels
	  ...
	  ;% helicopter_10_4_optional_P.HILInitialize_active
	  section.data(1).logicalSrcIdx = 41;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_final_digital_out
	  section.data(2).logicalSrcIdx = 42;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_initial_digital_o
	  section.data(3).logicalSrcIdx = 43;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_analog_input_
	  ...
	  ;% helicopter_10_4_optional_P.HILInitialize_set_analog_output
	  ...
	  ;% helicopter_10_4_optional_P.HILInitialize_set_analog_outp_e
	  ...
	  ;% helicopter_10_4_optional_P.HILInitialize_set_analog_out_ex
	  section.data(11).logicalSrcIdx = 51;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_analog_outp_p
	  section.data(12).logicalSrcIdx = 52;
	  section.data(12).dtTransOffset = 11;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_clock_frequen
	  section.data(13).logicalSrcIdx = 53;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_clock_frequ_e
	  section.data(14).logicalSrcIdx = 54;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_clock_params_
	  section.data(15).logicalSrcIdx = 55;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_clock_param_c
	  section.data(16).logicalSrcIdx = 56;
	  section.data(16).dtTransOffset = 15;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_digital_outpu
	  section.data(17).logicalSrcIdx = 57;
	  section.data(17).dtTransOffset = 16;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_digital_out_b
	  section.data(18).logicalSrcIdx = 58;
	  section.data(18).dtTransOffset = 17;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_digital_out_c
	  section.data(19).logicalSrcIdx = 59;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_digital_ou_c1
	  section.data(20).logicalSrcIdx = 60;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_digital_out_a
	  section.data(21).logicalSrcIdx = 61;
	  section.data(21).dtTransOffset = 20;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_digital_out_j
	  section.data(22).logicalSrcIdx = 62;
	  section.data(22).dtTransOffset = 21;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_digital_out_m
	  section.data(23).logicalSrcIdx = 63;
	  section.data(23).dtTransOffset = 22;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_encoder_count
	  ...
	  ;% helicopter_10_4_optional_P.HILInitialize_set_encoder_param
	  ...
	  ;% helicopter_10_4_optional_P.HILInitialize_set_other_outpu_l
	  section.data(28).logicalSrcIdx = 68;
	  section.data(28).dtTransOffset = 27;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_pwm_outputs_a
	  ...
	  ;% helicopter_10_4_optional_P.HILInitialize_set_pwm_output_ap
	  section.data(32).logicalSrcIdx = 72;
	  section.data(32).dtTransOffset = 31;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_pwm_outputs_o
	  section.data(33).logicalSrcIdx = 73;
	  section.data(33).dtTransOffset = 32;
	
	  ;% helicopter_10_4_optional_P.HILInitialize_set_pwm_params_at
	  ...
	  ;% helicopter_10_4_optional_P.Gain_Gain
	  ...
	  ;% helicopter_10_4_optional_P.Gain_Gain_a
	  ...
	  ;% helicopter_10_4_optional_P.Gain_Gain_l
	  ...
	  ;% helicopter_10_4_optional_P.Gain1_Gain
	  ...
	  ;% helicopter_10_4_optional_P.Gain_Gain_a1
	  ...
	  ;% helicopter_10_4_optional_P.HILReadEncoderTimebase_Active
	  section.data(1).logicalSrcIdx = 107;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_10_4_optional_P.HILWriteAnalog_Active
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (helicopter_10_4_optional_B)
    ;%
      section.nData     = 17;
	  ...
	  ;% helicopter_10_4_optional_B.Gain
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	  ...
	  ;% helicopter_10_4_optional_B.Gain_e
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 6;
	  ...
	  ;% helicopter_10_4_optional_B.K_ei
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helicopter_10_4_optional_B.Gain_l
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 14;
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (helicopter_10_4_optional_DW)
    ;%
      section.nData     = 13;
      section.data(13)  = dumData; %prealloc
      
	  ;% helicopter_10_4_optional_DW.HILInitialize_AIMinimums
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_10_4_optional_DW.HILInitialize_AIMaximums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 8;
	
	  ;% helicopter_10_4_optional_DW.HILInitialize_AOMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 16;
	
	  ;% helicopter_10_4_optional_DW.HILInitialize_AOMaximums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 24;
	
	  ;% helicopter_10_4_optional_DW.HILInitialize_AOVoltages
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 32;
	
	  ;% helicopter_10_4_optional_DW.HILInitialize_FilterFrequency
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 40;
	
	  ;% helicopter_10_4_optional_DW.HILInitialize_POSortedFreqs
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 48;
	
	  ;% helicopter_10_4_optional_DW.HILInitialize_POValues
	  section.data(8).logicalSrcIdx = 7;
	  ...
	  ;% helicopter_10_4_optional_DW.LastUAtTimeA
	  section.data(10).logicalSrcIdx = 9;
	  ...
	  ;% helicopter_10_4_optional_DW.LastUAtTimeB
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 67;
	
	  ;% helicopter_10_4_optional_DW.HILWriteAnalog_Buffer
	  section.data(13).logicalSrcIdx = 12;
	  ...
	  ;% helicopter_10_4_optional_DW.ToFile_PWORK.FilePtr
	  section.data(1).logicalSrcIdx = 15;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_10_4_optional_DW.ToFile1_PWORK.FilePtr
	  section.data(2).logicalSrcIdx = 16;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_10_4_optional_DW.ToFile2_PWORK.FilePtr
	  section.data(3).logicalSrcIdx = 17;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_10_4_optional_DW.ToFile3_PWORK.FilePtr
	  ...
	  ;% helicopter_10_4_optional_DW.Vd_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 21;
	  section.data(7).dtTransOffset = 6;
	
	  ;% helicopter_10_4_optional_DW.Vs_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 22;
	  section.data(8).dtTransOffset = 7;
	
	  ;% helicopter_10_4_optional_DW.ElevationScopedegs_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 23;
	  section.data(9).dtTransOffset = 8;
	
	  ;% helicopter_10_4_optional_DW.ElevationScopedeg_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 24;
	  section.data(10).dtTransOffset = 9;
	
	  ;% helicopter_10_4_optional_DW.PitchScopedeg_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 25;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helicopter_10_4_optional_DW.PtichrateScopedegs_PWORK.LoggedData
	  section.data(12).logicalSrcIdx = 26;
	  section.data(12).dtTransOffset = 11;
	
	  ;% helicopter_10_4_optional_DW.PtichrateScopedegs1_PWORK.LoggedData
	  section.data(13).logicalSrcIdx = 27;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helicopter_10_4_optional_DW.TravelrateScopedegs_PWORK.LoggedData
	  section.data(14).logicalSrcIdx = 28;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helicopter_10_4_optional_DW.TravelScopedeg_PWORK.LoggedData
	  section.data(15).logicalSrcIdx = 29;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helicopter_10_4_optional_DW.Backmotor_PWORK.LoggedData
	  section.data(16).logicalSrcIdx = 30;
	  section.data(16).dtTransOffset = 15;
	
	  ;% helicopter_10_4_optional_DW.Frontmotor_PWORK.LoggedData
	  section.data(17).logicalSrcIdx = 31;
	  section.data(17).dtTransOffset = 16;
	
	  ;% helicopter_10_4_optional_DW.HILWriteAnalog_PWORK
	  ...
	  ;% helicopter_10_4_optional_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 33;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_10_4_optional_DW.HILInitialize_QuadratureModes
	  section.data(2).logicalSrcIdx = 34;
	  section.data(2).dtTransOffset = 3;
	
	  ;% helicopter_10_4_optional_DW.HILInitialize_InitialEICounts
	  section.data(3).logicalSrcIdx = 35;
	  section.data(3).dtTransOffset = 11;
	
	  ;% helicopter_10_4_optional_DW.HILInitialize_POModeValues
	  section.data(4).logicalSrcIdx = 36;
	  section.data(4).dtTransOffset = 19;
	
	  ;% helicopter_10_4_optional_DW.HILInitialize_POAlignValues
	  section.data(5).logicalSrcIdx = 37;
	  section.data(5).dtTransOffset = 27;
	
	  ;% helicopter_10_4_optional_DW.HILInitialize_POPolarityVals
	  section.data(6).logicalSrcIdx = 38;
	  section.data(6).dtTransOffset = 35;
	
	  ;% helicopter_10_4_optional_DW.HILReadEncoderTimebase_Buffer
	  section.data(7).logicalSrcIdx = 39;
	  ...
	  ;% helicopter_10_4_optional_DW.HILInitialize_POSortedChans
	  ...
	  ;% helicopter_10_4_optional_DW.ToFile_IWORK.Count
	  section.data(1).logicalSrcIdx = 41;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_10_4_optional_DW.ToFile1_IWORK.Count
	  section.data(2).logicalSrcIdx = 42;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_10_4_optional_DW.ToFile2_IWORK.Count
	  section.data(3).logicalSrcIdx = 43;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_10_4_optional_DW.ToFile3_IWORK.Count
	  section.data(4).logicalSrcIdx = 44;
	  section.data(4).dtTransOffset = 3;
  ...
  targMap.checksum0 = 1094680152;
  targMap.checksum1 = 1760930674;
  targMap.checksum2 = 3094032520;
  targMap.checksum3 = 1506356078;
