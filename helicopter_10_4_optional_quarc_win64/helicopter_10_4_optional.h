...
#ifndef RTW_HEADER_helicopter_10_4_optional_h_
#define RTW_HEADER_helicopter_10_4_optional_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopter_10_4_optional_COMMON_INCLUDES_
# define helicopter_10_4_optional_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* helicopter_10_4_optional_COMMON_INCLUDES_ */

#include "helicopter_10_4_optional_types.h"
...
#define helicopter_10_4_optional_rtModel RT_MODEL_helicopter_10_4_opti_T
...
typedef struct {
  ...
  real_T ElevationTransferFcn_CSTATE;  /* '<S4>/Elevation: Transfer Fcn' */
  real_T Integrator_CSTATE;            /* '<S3>/Integrator' */
} XDot_helicopter_10_4_optional_T;
...
} XDis_helicopter_10_4_optional_T;
...
#define rtB                            helicopter_10_4_optional_B
#define BlockIO                        B_helicopter_10_4_optional_T
#define rtX                            helicopter_10_4_optional_X
#define ContinuousStates               X_helicopter_10_4_optional_T
#define rtXdot                         helicopter_10_4_optional_XDot
#define StateDerivatives               XDot_helicopter_10_4_optional_T
#define tXdis                          helicopter_10_4_optional_XDis
#define StateDisabled                  XDis_helicopter_10_4_optional_T
#define rtP                            helicopter_10_4_optional_P
#define Parameters                     P_helicopter_10_4_optional_T
#define rtDWork                        helicopter_10_4_optional_DW
#define D_Work                         DW_helicopter_10_4_optional_T

/* Parameters (auto storage) */
struct P_helicopter_10_4_optional_T_ {
...
struct tag_RTM_helicopter_10_4_optio_T {
  const char_T *path;
...
extern P_helicopter_10_4_optional_T helicopter_10_4_optional_P;

/* Block signals (auto storage) */
extern B_helicopter_10_4_optional_T helicopter_10_4_optional_B;

/* Continuous states (auto storage) */
extern X_helicopter_10_4_optional_T helicopter_10_4_optional_X;

/* Block states (auto storage) */
extern DW_helicopter_10_4_optional_T helicopter_10_4_optional_DW;

/* Model entry point functions */
extern void helicopter_10_4_optional_initialize(void);
extern void helicopter_10_4_optional_output(void);
extern void helicopter_10_4_optional_update(void);
extern void helicopter_10_4_optional_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter_10_4_optional_rtModel *helicopter_10_4_optional(void);
...
extern RT_MODEL_helicopter_10_4_opti_T *const helicopter_10_4_optional_M;
 ...
 *
 * '<Root>' : 'helicopter_10_4_optional'
 * '<S1>'   : 'helicopter_10_4_optional/Conversion'
 * '<S2>'   : 'helicopter_10_4_optional/Degrees to Radians'
 * '<S3>'   : 'helicopter_10_4_optional/Elevation controller'
 * '<S4>'   : 'helicopter_10_4_optional/Helicopter_interface'
 * '<S5>'   : 'helicopter_10_4_optional/Pitch controller'
 * '<S6>'   : 'helicopter_10_4_optional/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'helicopter_10_4_optional/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'helicopter_10_4_optional/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'helicopter_10_4_optional/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'helicopter_10_4_optional/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'helicopter_10_4_optional/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'helicopter_10_4_optional/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_10_4_optional_h_ */
