 ...
 * '<S5>'   : 'helicopter_10_4/Pitch controller'
 * '<S6>'   : 'helicopter_10_4/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'helicopter_10_4/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'helicopter_10_4/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'helicopter_10_4/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'helicopter_10_4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'helicopter_10_4/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'helicopter_10_4/Helicopter_interface/Travel rate  rad to deg'
 */
