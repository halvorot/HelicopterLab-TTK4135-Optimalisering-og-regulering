...
[z,fval] = fmincon(obj_func, z0, [],[], Aeq, beq, vlb, vub, @c_con2, opt);
...
% Making struct for Simulink (for without feedback)
u1_star.time = t;
u1_star.signals.values = u1;
u1_star.signals.dimentions = 1;

u2_star.time = t;
u2_star.signals.values = u2;
u2_star.signals.dimentions = 1;
